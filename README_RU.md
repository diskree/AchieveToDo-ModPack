...
:pick: Подсказки к достижениям с прогрессом
...
:x: Удалён запрет на выпадение тотема бессмертия, но получить его можно будет только убив вызывателя в лесном особняке

:x: Возможность при создании мира настроить выдачу наград за выполнение достижений (предметы, опыт, трофеи)
...
:white_check_mark: `Minecraft 1.20-pre6` от _25.05.2023_

:white_check_mark: `BlazeandCaves 1.16 Beta Build 6` от _17.05.2023_

:white_check_mark: `BlazeandCaves Hardcore 1.15` от _16.09.2022_

:white_check_mark: `BlazeandCaves Language Pack` от _26.01.2023_
