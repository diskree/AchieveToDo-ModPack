...
Эта сборка создана только для одиночной игры и основана на Minecraft 1.20.1 + 💜 [Sugar](https://modrinth.com/modpack/sugar). Спасибо за большую работу над оптимизацией и качеством игры в Minecraft!
...
BlazeandCaves уже настроен для работы со сборкой. Вы можете настроить награды за выполнение достижений при создании мира. Табло справа, с текущим количеством выполненных достижений, включено по умолчанию. Вы также можете создать хардкорный мир, необходимая версия датапака уже внутри и включится автоматически.
