...
public enum BlockedAction {
    ...
    EAT_COD(null, BlockedActionType.FOOD, FoodComponents.COD, 3),
    EAT_TROPICAL_FISH(null, BlockedActionType.FOOD, FoodComponents.TROPICAL_FISH, 4),
    EAT_ROTTEN_FLESH(null, BlockedActionType.FOOD, FoodComponents.ROTTEN_FLESH, 6),
    JUMP("Вы сейчас не можете прыгать", BlockedActionType.ACTION, null, 7),
    EAT_SPIDER_EYE(null, BlockedActionType.FOOD, FoodComponents.SPIDER_EYE, 8),
    SPRINT("Вы сейчас не можете бегать", BlockedActionType.ACTION, null, 10),
    EAT_CHICKEN(null, BlockedActionType.FOOD, FoodComponents.CHICKEN, 14),
    EAT_POISONOUS_POTATO(null, BlockedActionType.FOOD, FoodComponents.POISONOUS_POTATO, 16),
    EAT_SUSPICIOUS_STEW(null, BlockedActionType.FOOD, FoodComponents.SUSPICIOUS_STEW, 19),
    EAT_MUTTON(null, BlockedActionType.FOOD, FoodComponents.MUTTON, 22),
    EAT_RABBIT(null, BlockedActionType.FOOD, FoodComponents.RABBIT, 24),
    BREAK_BLOCKS_IN_POSITIVE_Y("Вы сейчас не можете ломать блоки", BlockedActionType.ACTION, null, 25),
    EAT_SWEET_BERRIES(null, BlockedActionType.FOOD, FoodComponents.SWEET_BERRIES, 27),
    EAT_PORKCHOP(null, BlockedActionType.FOOD, FoodComponents.PORKCHOP, 29),
    EAT_BEETROOT(null, BlockedActionType.FOOD, FoodComponents.BEETROOT, 37),
    EAT_BEETROOT_SOUP(null, BlockedActionType.FOOD, FoodComponents.BEETROOT_SOUP, 45),
    USING_CRAFTING_TABLE("Вы сейчас не можете использовать верстак", BlockedActionType.BLOCK, null, 50),
    EAT_CARROT(null, BlockedActionType.FOOD, FoodComponents.CARROT, 52),
    EAT_APPLE(null, BlockedActionType.FOOD, FoodComponents.APPLE, 55),
    EAT_POTATO(null, BlockedActionType.FOOD, FoodComponents.POTATO, 58),
    USING_FURNACE("Вы сейчас не можете использовать печь", BlockedActionType.BLOCK, null, 60),
    EAT_DRIED_KELP(null, BlockedActionType.FOOD, FoodComponents.DRIED_KELP, 62),
    EAT_MELON_SLICE(null, BlockedActionType.FOOD, FoodComponents.MELON_SLICE, 64),
    USING_IRON_TOOLS("Вы сейчас не можете использовать железные инструменты", BlockedActionType.TOOLS, null, 70),
    EAT_COOKIE(null, BlockedActionType.FOOD, FoodComponents.COOKIE, 72),
    EAT_HONEY_BOTTLE(null, BlockedActionType.FOOD, FoodComponents.HONEY_BOTTLE, 77),
    USING_BOAT("Вы сейчас не можете садиться в лодку", BlockedActionType.ACTION, null, 80),
    EAT_BEEF(null, BlockedActionType.FOOD, FoodComponents.BEEF, 88),
    ...
    EAT_BREAD(null, BlockedActionType.FOOD, FoodComponents.BREAD, 100),
    EAT_RABBIT_STEW(null, BlockedActionType.FOOD, FoodComponents.RABBIT_STEW, 105),
    EQUIP_IRON_ARMOR("Вы сейчас не можете одевать железную броню", BlockedActionType.ARMOR, null, 110),
    EAT_MUSHROOM_STEW(null, BlockedActionType.FOOD, FoodComponents.MUSHROOM_STEW, 111),
    USING_SMOKER("Вы сейчас не можете использовать коптильню", BlockedActionType.BLOCK, null, 125),
    EAT_PUMPKIN_PIE(null, BlockedActionType.FOOD, FoodComponents.PUMPKIN_PIE, 145),
    ...
    EAT_COOKED_SALMON(null, BlockedActionType.FOOD, FoodComponents.COOKED_SALMON, 190),
    EAT_COOKED_COD(null, BlockedActionType.FOOD, FoodComponents.COOKED_COD, 195),
    BREAK_BLOCKS_IN_NEGATIVE_Y("Вы сейчас не можете ломать блоки ниже 0 высоты", BlockedActionType.ACTION, null, 200),
    EAT_GLOW_BERRIES(null, BlockedActionType.FOOD, FoodComponents.GLOW_BERRIES, 240),
    NETHER("Нижний Мир закрыт", BlockedActionType.PORTAL, null, 300),
    EAT_GOLDEN_APPLE(null, BlockedActionType.FOOD, FoodComponents.GOLDEN_APPLE, 333),
    USING_DIAMOND_TOOLS("Вы сейчас не можете использовать алмазные инструменты", BlockedActionType.TOOLS, null, 350),
    EAT_BAKED_POTATO(null, BlockedActionType.FOOD, FoodComponents.BAKED_POTATO, 370),
    EQUIP_DIAMOND_ARMOR("Вы сейчас не можете одевать алмазную броню", BlockedActionType.ARMOR, null, 400),
    EAT_COOKED_RABBIT(null, BlockedActionType.FOOD, FoodComponents.COOKED_RABBIT, 420),
    USING_BREWING_STAND("Вы сейчас не можете использовать зельеварку", BlockedActionType.BLOCK, null, 450),
    EAT_PUFFERFISH(null, BlockedActionType.FOOD, FoodComponents.PUFFERFISH, 455),
    EAT_COOKED_CHICKEN(null, BlockedActionType.FOOD, FoodComponents.COOKED_CHICKEN, 500),
    EAT_COOKED_MUTTON(null, BlockedActionType.FOOD, FoodComponents.COOKED_MUTTON, 525),
    USING_BEACON("Вы сейчас не можете использовать маяк", BlockedActionType.BLOCK, null, 600),
    EAT_COOKED_PORKCHOP(null, BlockedActionType.FOOD, FoodComponents.COOKED_PORKCHOP, 635),
    USING_NETHERITE_TOOLS("Вы сейчас не можете использовать незеритовые инструменты", BlockedActionType.TOOLS, null, 650),
    EAT_COOKED_BEEF(null, BlockedActionType.FOOD, FoodComponents.COOKED_BEEF, 675),
    ...
    EAT_CHORUS_FRUIT(null, BlockedActionType.FOOD, FoodComponents.CHORUS_FRUIT, 740),
    EQUIP_ELYTRA("Вы сейчас не можете одевать элитры", BlockedActionType.ARMOR, null, 775),
    EAT_ENCHANTED_GOLDEN_APPLE(null, BlockedActionType.FOOD, FoodComponents.ENCHANTED_GOLDEN_APPLE, 777),
    ...
    EAT_GOLDEN_CARROT(null, BlockedActionType.FOOD, FoodComponents.GOLDEN_CARROT, 888),
