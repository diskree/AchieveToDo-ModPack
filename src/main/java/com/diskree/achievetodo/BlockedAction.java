...
public enum BlockedAction {
    ...
    using_iron_tools("Вы сейчас не можете использовать железные инструменты", BlockedActionType.TOOLS, null, null, 70),
    ...
    equip_iron_armor("Вы сейчас не можете одевать железную броню", BlockedActionType.ARMOR, null, null, 110),
