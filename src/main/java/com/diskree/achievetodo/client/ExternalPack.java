...
public enum ExternalPack {
    ...
    private final boolean isAdvancementsPack;

    ExternalPack(String name, Formatting color, String pageUrl, String downloadUrl, String sha1, boolean isAdvancementsPack) {
        this.name = name;
        this.color = color;
        this.pageUrl = pageUrl;
        this.downloadUrl = downloadUrl;
        this.sha1 = sha1;
        this.isAdvancementsPack = isAdvancementsPack;
    }
    ...
    public boolean isAdvancementsPack() {
        return isAdvancementsPack;
    }
