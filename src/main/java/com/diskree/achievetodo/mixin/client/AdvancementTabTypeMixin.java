...
public class AdvancementTabTypeMixin {
    ...
    public int getTabXModify(int constant) {
        ...
        return client.currentScreen.width - AchieveToDo.ADVANCEMENTS_SCREEN_MARGIN * 2 - 4;
    }
    ...
    public int getTabYModify(int constant) {
        ...
        return client.currentScreen.height - AchieveToDo.ADVANCEMENTS_SCREEN_MARGIN * 2 - 4;
    }
}
