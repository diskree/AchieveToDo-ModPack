...
execute run function bc_rewards:bacap/achievetodo_setup_reward_item
execute run function bc_rewards:bacap/achievetodo_setup_reward_xp
execute run function bc_rewards:bacap/achievetodo_setup_reward_trophy
